            ...
            {{-- @if (auth()->user()->role == 'Super' || auth()->user()->role == 'Admin') --}}
                ...
                <li class="mb-2 bg-white rounded cursor-pointer">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('dashboard') }}">Room</a></li>
                        <li><a class="dropdown-item" href="{{ route('dashboard') }}">Type</a></li>
                        <li><a class="dropdown-item" href="{{ route('dashboard') }}">Status</a></li>
                        <li><a class="dropdown-item" href="{{ route('dashboard') }}">Facility</a></li>
                    </ul>
                </li>
                <li class="mb-2 bg-white rounded cursor-pointer">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('dashboard') }}">Customer</a></li>
                        {{-- @if (auth()->user()->role == 'Super') --}}
                            <li><a class="dropdown-item" href="{{ route('dashboard') }}">User</a></li>
                        {{-- @endif --}}
                    </ul>
                </li>
            {{-- @endif --}}
